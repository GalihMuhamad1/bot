...
let papako = [{
	...
	case 'menu': case 'help':
			try {
				...
				chatt = 'https://i.top4top.io/p_2153f1bgs0.jpg'
				}
...
`
if(menusimple == false){
sendButDoc(from, ini_anu, `𝐏𝐥𝐞𝐚𝐬𝐞 𝐝𝐨𝐧'𝐭 𝐬𝐩??𝐦 𝐛𝐨𝐭, 𝐩𝐚𝐮𝐬?? 𝟓 𝐬𝐞𝐜𝐨𝐧𝐝𝐬 𝐩𝐞𝐫 𝐜𝐨𝐦𝐦𝐚𝐧𝐝.\n𝐓𝐡𝐚𝐧𝐤𝐬!`, sender, koko, ini_mark)
